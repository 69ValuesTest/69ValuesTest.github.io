questions = [
    ...
    {
        "question": "All research should be conducted on a international scale.",
        "effect": {
            "econ": 0,
            "dipl": 10,
            "govt": 0,
    ...
    {
        "question": "The general population makes poor decisions.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -5,
    ...
    {
        "question": "The very existence of the state is a threat to our society.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 20,
    ...
    {
        "question": "The stronger the leadership, the more stable it is.",
        "effect": {
            "econ": 0,
            "dipl": -10,
            "govt": -10,
    ...
    {
        "question": "Environmental regulations are needed to defend our ecosystems.",
        "effect": {
            "econ": 10,
            "dipl": 0,
            "govt": 0,
    ...
    {
        "question": "Society was more perfect many years ago than it is now.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 0,
    ...
    {
        "question": "It is important that we maintain the traditions of our ancestors.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 0,
    ...
    {
        "question": "Foreign Aid is more important than maintaining our culture.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 0,
    ...
    {
        "question": "All drug use should be decriminalized.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 10,
    ...
    {
        "question": "Same-sex marriage should be outlawed and punishable by whippings or death.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -10,
    ...
    {
        "question": "No cultures are superior to others in any shape or form.",
        "effect": {
            "econ": 0,
            "dipl": 10,
            "govt": 5,
    ...
    {
        "question": "Sex outside marriage is immoral and should be punished severely.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -5,
    ...
    {
        "question": "If we accept migrants at all, it is important that they must assimilate into our culture.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -5,
    ...
    {
        "question": "Abortion should be prohibited in all cases, no matter the severity or what happened.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -10,
    ...
    {
        "question": "Gun ownership should be restricted to those without a valid reason.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -10,
    ...
    {
        "question": "Prostitution should be punished with force.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": -10,
    ...
    {
        "question": "Maintaining our values is the key to a perfect society.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 0,
    ...
    {
        "question": "Progressivism has poisoned society at a point of no return.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 0,
    ...
    {
        "question": "Genetic modification should be open to all citizens for free.",
        "effect": {
            "econ": 0,
            "dipl": 0,
            "govt": 0,
    ...
    {
        "question": "We should open our borders to immigration, regardless of origin.",
        "effect": {
            "econ": 0,
            "dipl": 10,
            "govt": 10,
    ...
    {
        "question": "We must secure the existence of OUR people, and a future for OUR children.",
        "effect": {
            "econ": -10,
            "dipl": -10,
            "govt": -10,
        ...
        {
        "question": "The industrial revolution and it's consequences were a disaster for the human race.",
        "effect": {
            "econ": 20,
            "dipl": 0,
            "govt": 0,
